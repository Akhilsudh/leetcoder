...
public class SimplifyPath {
  public String simplifyPath(String path) {
    ...
    List<String> canonicalPath = new ArrayList<String>();
    for(String element: pathElements) {
        if(element.equals("") || element.equals(".") || (element.equals("..") && canonicalPath.size() == 0)) {
          continue;
        }
          ...
          canonicalPath.add(element);
        }
    }
    String result = "";
    for(String element: canonicalPath) {
      result += "/" + element;
    }
